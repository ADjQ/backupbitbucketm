...
public class BitBucketIssue {
    ...
    @JsonProperty("assignee")
    public void setAssignee(BitBucketUser assignee) { this.assignee = assignee; }
    ...
    @JsonProperty("comments")
    public void setComments(List<BitBucketComment> comments) {
    ...
    public String toString() {
        ...
        sb.append(BitBucketIssue.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
